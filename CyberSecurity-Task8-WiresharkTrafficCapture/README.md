...
```bash
which wireshark The executable was located at:
...
SYN – The client requests to establish a TCP connection.
SYN-ACK – The server acknowledges the request and responds with its own SYN.
